...
export async function validatePrompt(promptData) {
  try {
    console.log('\n' + '='.repeat(80));
    console.log('🔍 QA AGENT - VALIDATING PROMPT');
    ...
    if (!modelConfig) {
      console.warn('⚠️  Unknown model:', promptData.model);
    }
    ...
    console.log('🤖 Calling GPT-4o for QA validation...');
...
🔍 DATING-SPECIFIC VALIDATION RULES:
